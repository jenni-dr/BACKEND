...
CREATE TABLE IF NOT EXIST SPORTMUSIC_PLAYLIST (
    id VARCHAR(255) PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXIST SPORTMUSIC_Genre (
    id VARCHAR(255) PRIMARY KEY,
    name VARCHAR(255) NOT NULL
    
);

CREATE TABLE IF NOT EXIST SPORTMUSIC_Album (
    id VARCHAR(255) PRIMARY KEY,
    name VARCHAR(255) NOT NULL
...
CREATE TABLE IF NOT EXIST SPORTMUSIC_Artista (
    id VARCHAR(255) PRIMARY KEY,
    name VARCHAR(255) NOT NULL
